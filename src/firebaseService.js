...
export const checkIfJoined = async (courseID, studentID) => {
  const courseRef = doc(db, 'courses', courseID);
  const courseSnapshot = await getDocs(collection(courseRef, 'students'));
  const student = courseSnapshot.docs.find(doc => doc.id === studentID);
